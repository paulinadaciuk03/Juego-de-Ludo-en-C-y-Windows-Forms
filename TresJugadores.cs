...
{
    public partial class TresJugadores : Form
    {
        ...
        RecorridoRojo rojo = new RecorridoRojo();
        ...
        private async void dadoBoton_Click(object sender, EventArgs e)
        {
            ...
            if (turno == 1) //turno VERDE
            {
                ...
                if (int.Parse(numDado.Text) == 6) //si el dado da 6 se puede mover cualquier ficha por lo tanto se iluminan y se activan
                {
                    if (contVerde == 0)
                    {
                        pieza1Verde.Location = new Point(47, 243);
        ...
        private async void pieza2Verde_Click(object sender, EventArgs e)
        {
